...
run_cmd do
  let env ← getEnv
  let root := `MathlibNt.SieveTheory.LiLiuOnePlusOneNine.GoldbachBig.goldbachWeight_paperSplit_allRetainedG11_consumed_small_epsilon
  let mut todo := [root]
  ...
  for n in [
    ...
    `MathlibNt.SieveTheory.LiLiuOnePlusOneNine.GoldbachBig.S4Retained.goldbachB8MainIntegral_eight_mul_le_60961168] do
