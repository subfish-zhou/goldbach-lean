import MathlibNt.SieveTheory.LiLiuGoldbachPaperSplitG11Consumed
import Lean
open Lean Elab Command in
run_cmd do
  let env ← getEnv
  let root := `MathlibNt.SieveTheory.LiLiuOnePlusOneNine.GoldbachBig.goldbachWeight_paperSplit_uniformG11_consumed_small_epsilon
  let mut todo := [root]
  ...
  for n in [
    ...
    `MathlibNt.SieveTheory.LiLiuOnePlusOneNine.GoldbachBig.goldbachWeight_remainingFive_rationalPositiveScalar_small_epsilon,
    ...
    `MathlibNt.SieveTheory.LiLiuOnePlusOneNine.GoldbachBig.g11UniformScalar_lt_upper] do
