...
/-- Original sifted mother bounded by actual labelled rectangle mass.
The actual Euler correction and distribution remainder
are proved, rather than supplied as target-shaped hypotheses. -/
theorem fouvryG9Sifted_mass_upper :
    ∃ C : ℝ, 0 < C ∧ ∃ K : ℝ, 1 < K ∧
      ∀ A : ℕ, ∀ e ε δ η ρ : ℝ,
