...
/-- The already proved sharper S3 constants are retained without recomputation.
...
theorem goldbachWeight_paperSplit_retainedG11_consumed_small_epsilon
    (δ : ℝ) (hδ : 0 < δ) :
    ∃ ε₀ : ℝ, 0 < ε₀ ∧ ε₀ ≤ (2/15 : ℝ) ∧
      ∀ ε : ℝ, 0 < ε → ε < ε₀ →
        ∃ N₀ : ℕ, 4 ≤ N₀ ∧ ∀ N : ℕ, N₀ ≤ N → Even N →
          ((goldbachWeightG6 (goldbachDifferenceCarrier N ε) N
            ...
            ((124337327/200000000 : ℝ)-goldbachB9PaperSplitIntegral-
  ...
  obtain ⟨ε₀,hε₀,hε₀u,hr⟩ := goldbachWeight_remainingFive_retained_small_epsilon
    (δ/2) (by positivity)
  refine ⟨ε₀,hε₀,hε₀u,?_⟩
  intro ε hε hεlt
