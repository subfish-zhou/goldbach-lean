...
endpoint to the fixed Case-I budget coordinate, with one threshold uniform in
both the depth `N` and the continuous coordinate `s`. -/
theorem caseI1423_sigmaZero_realEndpoint_sourceBound_uniform
    (S : BoundingSieve) (H : Section13HatLayers)
    (C C145 K d Δ : ℝ)
    (hH : Section13HatSourceContract H)
    (hd1 : 1 < d) (hΔ0 : 0 < Δ) (hΔ1 : Δ < 1)
    (hC : 0 < C) (hC145 : 0 ≤ C145) :
    ∃ A0 : ℝ, 0 ≤ A0 ∧ ∀ᶠ D : ℕ in atTop,
      ∀ (N : ℕ) (s : ℝ),
