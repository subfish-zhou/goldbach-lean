...
theorem goldbachG11_exceptions_normalized (delta : ℝ) (hdelta : 0 < delta) :
    ∃ N0 : ℕ, 4 ≤ N0 ∧ ∀ N : ℕ, N0 ≤ N → ∀ eps : ℝ, 0 ≤ eps →
