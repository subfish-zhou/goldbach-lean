...
theorem betaClean_wMaskedTruncated_largeSupport_dyadic_kscale
    (i k j A : ℕ) {η Cscale : ℝ} (hη : 0 < η) (hCscale : 1 ≤ Cscale) :
  ...
  have hheadPower := hpower M (2 * T) hM (by linarith) hMT
