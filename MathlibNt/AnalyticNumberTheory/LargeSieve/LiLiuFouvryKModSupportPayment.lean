import MathlibNt.AnalyticNumberTheory.LargeSieve.LiLiuFouvryKModSupportOriginal
...
theorem eventually_wMaskedOriginal_zero_modulus_support_power_saving_kscale
  ...
  obtain ⟨C, hC, hOriginal⟩ :=
    wMaskedOriginal_abs_le_modulus_support_kscale Cscale hCscale j (show 0 < η / 8 by linarith)
  obtain ⟨D, hD, hZero⟩ :=
