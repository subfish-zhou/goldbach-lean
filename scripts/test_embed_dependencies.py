...
class DependencyPanelTests(unittest.TestCase):
    def test_nested_block_and_apostrophe_anchor(self):
        ...
        bindings = {"Example.fact'": ('../assets/dependencies/panel.html?module=1&decl=Example.fact%27', "Example.fact'")}
    ...
    def test_math_placeholder_and_escaped_title(self):
        ...
        result, count = inject_panels(text, {'bp:stage': ('../assets/dependencies/panel.html?module=2&decl=x', 'A < B')}, 'x', 'y')
        self.assertEqual(count, 1)
