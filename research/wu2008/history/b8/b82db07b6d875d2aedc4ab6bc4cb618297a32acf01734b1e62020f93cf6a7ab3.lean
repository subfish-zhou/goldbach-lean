import W14AcceptedThreshold
import Lean
open Lean Elab Command

elab "#w14_parent_cone" : command => do
  let env := (← getEnv).setExporting false
  for root in #[`WuTarget.W14.block_gt, `WuTarget.W14Accepted.block_with_retained_slack,
      `WuTarget.W14Accepted.paidCoefficient, `WuTarget.W14Accepted.enhanced_P2_paid] do
    let mut todo := #[root]
