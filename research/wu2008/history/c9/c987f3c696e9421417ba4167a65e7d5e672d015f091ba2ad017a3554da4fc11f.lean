...
elab "#w12_parent_cone" : command => do
  let env := (← getEnv).setExporting false
  for root in #[`WuTarget.W12.weightedDebit_le_analyticUpper, `WuTarget.W12.weightedDebit_lt_debitCeiling,
      `WuTarget.W12Accepted.paidCoefficient, `WuTarget.W12Accepted.enhanced_P2_paid] do
    let mut todo := #[root]
