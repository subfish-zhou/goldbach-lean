...
theorem seed_eq_publication_add_increment (i : Fin 9) :
  ...
  fin_cases i <;>
    norm_num [seed, seedQ, increment, NineFeedbackStrength.publication,
      Wu04CurvePaid.publication, Wu04RemainingCore.publication, Wu04FirstCore.publication]
...
theorem increment_le_half_slack (i : Fin 9) : increment i ≤ forcingSlack i / 2 := by
  ...
  · norm_num [increment, forcingSlack]
