...
elab "#w11_parent_cone" : command => do
  let env := (← getEnv).setExporting false
  for root in #[`WuTarget.W11.actual_pair_upper, `WuTarget.W11.actual_correlated_lower,
      `WuTarget.W11Accepted.selectedCredit, `WuTarget.W11Accepted.enhanced_P2_paid] do
    let mut todo := #[root]
