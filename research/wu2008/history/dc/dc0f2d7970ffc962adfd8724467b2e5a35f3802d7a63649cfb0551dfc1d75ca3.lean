...
theorem Aa_closed_endpoints :
  ...
  · simpa using jr1965f_normalized_firstInterval (s := 4) (by norm_num) le_rfl
  · simpa using lower_middle (s := 6) (by norm_num) le_rfl
  · simpa using lower_terminal (s := 8) (by norm_num) le_rfl
