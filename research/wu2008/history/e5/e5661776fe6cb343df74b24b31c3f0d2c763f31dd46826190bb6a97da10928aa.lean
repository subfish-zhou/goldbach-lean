...
elab "#w15_parent_cone" : command => do
  let env := (← getEnv).setExporting false
  for root in #[`WuTarget.W15.highGain_lower, `WuTarget.W15.independent_rational,
      `WuTarget.W15Accepted.paidCoefficient, `WuTarget.W15Accepted.enhanced_P2_paid] do
    let mut todo := #[root]
