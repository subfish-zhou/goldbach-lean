...
elab "#w17_accepted_complete_cone" : command => do
  let env := (← getEnv).setExporting false
  for root in #[`WuTarget.W17Joint.symbolic_same_delta_system, `WuTarget.W17Accepted.enhanced_ordinary_P2,
      `WuTarget.W17Accepted.paidCoefficient, `WuTarget.W17Accepted.refined_target] do
    let mut todo := #[root]
