...
theorem lowerDomain_eq (p : SecondFunctionalParameters) (hp : p.MotherAdmissible)
  ...
  fin_cases j <;> ext t <;>
    norm_num [lowerDomain, LowerTripleContinuous.D, LowerTripleGrouped.bands] <;> grind
...
theorem fourDomain_eq (p : SecondFunctionalParameters) (hp : p.MotherAdmissible)
  ...
  fin_cases j <;> ext t <;>
    norm_num [fourDomain, massDomainFour, FourPrimeContinuous.D16,
      FourPrimeContinuous.D17, FourPrimeContinuous.D18, FourPrimeContinuous.D19] <;> grind
...
theorem D9_fibres (p : SecondFunctionalParameters) (t : Fin 3 → ℝ) :
  ...
  simp only [D9, mem_ofPred_eq, mem_Icc]
  grind
