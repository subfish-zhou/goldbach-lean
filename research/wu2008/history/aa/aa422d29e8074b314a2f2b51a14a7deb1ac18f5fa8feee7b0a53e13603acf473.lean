...
theorem gamma5Mass_section_regular {C D : ℝ}
  ...
  constructor
  · intro t
    simpa only [gamma5MassSection, show (4 : ℝ) * 4 = 16 by norm_num] using
...
theorem gamma5Mass_rectangle_eq {A B C D : ℝ}
    (_hA : gamma5MassA ≤ A) (hAB : A ≤ B) (hB : B ≤ gamma5ClassicalB)
    (_hC : gamma5MassA ≤ C) (hCD : C ≤ D) (hD : D ≤ gamma5ClassicalB) :
