...
theorem paidTable_row0 (k : Fin 9) :
  ...
  fin_cases k <;> norm_num [paidTable, rationalEntry, rationalInterval, rationalDensity,
    rationalKernel, firstSplit, secondSplit, upperSwitch, lowerSwitch, left, right, clip,
    upperLeft, upperNode, coupledRow, SecondFunctionalPositive.parameters,
    SecondFunctionalParameters.row1, feedbackLower, feedbackUpper, feedbackPole,
    upperP, upperQ, lowerQ, ratio]
...
theorem paidTable_row1 (k : Fin 9) :
  ...
  fin_cases k <;> norm_num [paidTable, rationalEntry, rationalInterval, rationalDensity,
    rationalKernel, firstSplit, secondSplit, upperSwitch, lowerSwitch, left, right, clip,
    upperLeft, upperNode, coupledRow, SecondFunctionalPositive.parameters,
    SecondFunctionalParameters.row2, feedbackLower, feedbackUpper, feedbackPole,
    upperP, upperQ, lowerQ, ratio]

theorem paidTable_row2_first :
    paidTable 2 0 = rationalEntry (coupledRow 2) 0 := by
  norm_num [paidTable, rationalEntry, rationalInterval, rationalDensity,
    rationalKernel, firstSplit, secondSplit, upperSwitch, lowerSwitch, left, right, clip,
    upperLeft, upperNode, coupledRow, SecondFunctionalPositive.parameters,
    SecondFunctionalParameters.row3, feedbackLower, feedbackUpper, feedbackPole,
    upperP, upperQ, lowerQ, ratio]
...
theorem paidTable_row2_rest (k : Fin 9) (hk : k ≠ 0) :
  ...
  fin_cases k
  · exact (hk rfl).elim
  all_goals norm_num [paidTable, rationalEntry, rationalInterval, rationalDensity,
    rationalKernel, firstSplit, secondSplit, upperSwitch, lowerSwitch, left, right, clip,
    upperLeft, upperNode, coupledRow, SecondFunctionalPositive.parameters,
    SecondFunctionalParameters.row3, feedbackLower, feedbackUpper, feedbackPole,
    upperP, upperQ, lowerQ, ratio]
...
theorem paidTable_row3_first :
  ...
  norm_num [paidTable, rationalEntry, rationalInterval, rationalDensity,
    rationalKernel, firstSplit, secondSplit, upperSwitch, lowerSwitch, left, right, clip,
    upperLeft, upperNode, coupledRow, SecondFunctionalPositive.parameters,
    SecondFunctionalParameters.row4, feedbackLower, feedbackUpper, feedbackPole,
    upperP, upperQ, lowerQ, ratio]
...
theorem paidTable_eq_rationalEntry (i : Fin 4) (k : Fin 9) :
  ...
  · by_cases hk : k = 0
    · subst k; exact paidTable_row2_first
