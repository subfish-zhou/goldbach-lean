...
theorem commonRadius_pos : 0 < commonRadius :=
  lt_min (radius_pos 0) (lt_min (radius_pos 1) (lt_min (radius_pos 2)
    (lt_min (radius_pos 3) (lt_min (radius_pos 4) (lt_min (radius_pos 5)
      (lt_min (radius_pos 6) (radius_pos 7)))))))

theorem commonRadius_le (i : Fin 8) : commonRadius ≤ radius i := by
  fin_cases i <;> simp [commonRadius]
