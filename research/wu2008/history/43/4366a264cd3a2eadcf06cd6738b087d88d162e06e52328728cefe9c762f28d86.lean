...
theorem gamma5Gain_triangle_bounds {v : ℝ × ℝ} (hv : gamma5GainTriangle v) :
  ...
  · dsimp [gamma5GainV, gamma5ClassicalS]
    norm_num [gamma5GainTriangle, gamma5MassA, gamma5ClassicalS, gamma5ClassicalB] at hv hx hy
    linarith [hv.2.2]
  · dsimp [gamma5GainV, gamma5ClassicalS]
    norm_num [gamma5GainTriangle, gamma5MassA, gamma5ClassicalS] at hv hy
    linarith [hv.1]
...
theorem gamma5Gain_kernel_eq_literal {δ t u : ℝ} (ht : gamma5MassA ≤ t)
  ...
  simp only [gamma5GainKernel, gamma5GainRegion, mem_ofPred_eq, gamma5GainTriangle,
