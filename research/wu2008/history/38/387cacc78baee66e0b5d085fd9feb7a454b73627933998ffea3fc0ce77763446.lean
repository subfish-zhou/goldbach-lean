...
theorem gamma6Base_C6_literal :
  ...
  norm_num [gamma6BaseC6, gamma6BaseIntegral, gamma5MassA, gamma5ClassicalS,
    gamma6BaseB, gamma6BaseC, gamma6BaseF, gamma5MassKernel]
...
theorem gamma6Base_C6_integrable :
  ...
  have hA : gamma5MassA = (25 / 103 : ℝ) := by norm_num [gamma5MassA, gamma5ClassicalS]
  rw [← hA]
  constructor
  · intro t ht
