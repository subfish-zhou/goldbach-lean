...
elab "#w13_tight_parent_cone" : command => do
  let env := (← getEnv).setExporting false
  for root in #[`WuTarget.W13Tight.original_pair_upper, `WuTarget.W13Tight.recovery_lower,
      `WuTarget.W13TightAccepted.paidCoefficient, `WuTarget.W13TightAccepted.refined_target] do
    let mut todo := #[root]
