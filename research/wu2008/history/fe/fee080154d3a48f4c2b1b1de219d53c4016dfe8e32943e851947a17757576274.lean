...
theorem massLower_exact :
  ...
  norm_num [massLower,smallLower,largeLower,Finset.sum_range_succ,error,cut,alpha,beta,
...
theorem massUpper_exact :
  ...
  norm_num [massUpper,smallUpper,largeUpper,Finset.sum_range_succ,error,cut,alpha,beta,
    truncatedSixthLowerAlpha,truncatedSixthLowerBeta]
