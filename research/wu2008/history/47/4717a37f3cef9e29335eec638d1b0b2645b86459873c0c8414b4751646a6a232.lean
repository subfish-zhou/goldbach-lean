...
theorem linear_integral (t : ℝ) :
  ...
  have hd (u : ℝ) :
    ...
    convert (((hasDerivAt_id u).sub_const 2).pow 2).const_mul (625/2809 : ℝ) using 1 <;> ring
...
theorem quadratic_integral :
  ...
  have hd (t : ℝ) :
    ...
    convert (((hasDerivAt_id t).sub_const 3).pow 3).const_mul (15625/657306 : ℝ) using 1 <;> ring
