...
theorem fifth_payment_signs :
  ...
  norm_num [fifthQuadratic, fifthLinear, f0, FifthLogTotalMagnitude.slope, lo, dLower,
...
theorem fifth_lower_exact : fifthLower =
  ...
  norm_num [fifthLower, fifthQuadratic, fifthLinear, f0, FifthLogTotalMagnitude.slope,
    lo, dLower, dUpper, FifthClassicalShape.q, JointLogTotalComparison.V,
