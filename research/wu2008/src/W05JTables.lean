...
theorem coupledTable2_s_exact (k : Fin 9) :
  ...
  change rationalJCoefficient (240 / 100) (446 / 100) k = coupledTable2_s k
  fin_cases k <;>
...
theorem coupledTable2_kappa2_exact (k : Fin 9) :
  ...
  change rationalJCoefficient (287 / 100) (446 / 100) k = coupledTable2_kappa2 k
  fin_cases k <;>
...
theorem coupledTable2_kappa3_exact (k : Fin 9) :
  ...
  change rationalJCoefficient (240 / 100) (446 / 100) k = coupledTable2_kappa3 k
  fin_cases k <;>
...
theorem coupledTable3_s_exact (k : Fin 9) :
  ...
  change rationalJCoefficient (250 / 100) (412 / 100) k = coupledTable3_s k
  fin_cases k <;>
...
theorem coupledTable3_kappa2_exact (k : Fin 9) :
  ...
  change rationalJCoefficient (291 / 100) (412 / 100) k = coupledTable3_kappa2 k
  fin_cases k <;>
...
theorem coupledTable3_kappa3_exact (k : Fin 9) :
  ...
  change rationalJCoefficient (250 / 100) (412 / 100) k = coupledTable3_kappa3 k
  fin_cases k <;>
...
theorem firstTable2_exact (k : Fin 9) :
  ...
  change rationalJCoefficient ((26 + (2 : ℝ)) / 10) (334 / 100) k = firstTable2 k
  fin_cases k <;>
...
theorem firstTable3_exact (k : Fin 9) :
  ...
  change rationalJCoefficient ((26 + (3 : ℝ)) / 10) (319 / 100) k = firstTable3 k
  fin_cases k <;>
...
theorem firstTable4_exact (k : Fin 9) :
  ...
  change rationalJCoefficient ((26 + (4 : ℝ)) / 10) 3 k = firstTable4 k
  fin_cases k <;>
