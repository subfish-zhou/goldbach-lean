...
def certifiedCredits : ℝ :=
  E03Sigma.ordinaryCredit + E07Fifth.netCredit + E02JointCredit.amount

/-- Remove the exact three paid components before combining their certificates. -/
def otherRemaining : ℝ :=
  W17Accepted.remainingCoefficient-W02Accepted.nodeGain/4-
    E07Accepted.fifthBalance-W17Accepted.jointCredit
