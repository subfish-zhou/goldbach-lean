...
theorem tailCap_small : tailCap < (1/1000 : ℝ) := by
  norm_num [tailCap,tailLogCap,outerCut,coefA,coefB,Fin.sum_univ_succ,
    recipCoeff,crossCap,WuTarget.E10FourMajor.slope,z0,
...
theorem scaled_parentCap_exceeds_target :
  ...
  norm_num [scale,pairCap,capTerm,Fin.sum_univ_succ,recipCoeff,crossCap,
    WuTarget.E10FourMajor.slope,z0,
