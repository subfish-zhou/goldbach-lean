import U8LargeClassical

/-! Same-mother residual with only the literal small-first-prime debit left.
No small-region upper, improved coefficient, or ordinary-P2 lower is a premise. -/
...
theorem fixed_small_debit {δ ε : ℝ}
    ...
    ∃ T : ℕ, 512 ≤ T ∧ ∀ N : ℕ, T ≤ N → Even N →
      (FullAdmissibleMother.psiCoefficient δ+8*oldSmallIntegral-ε)*
